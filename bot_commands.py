...
async def about_me(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(
        ...
        f"Разработчик бота 'IT_Master' Грицун К. И он очень любит свою маму, которая помогает ему править код:)\n"
        f"Связаться с автором: @Voitel1356"
    )
...
async def message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif user_input.lower() in ['меню','привет', 'menu']:
